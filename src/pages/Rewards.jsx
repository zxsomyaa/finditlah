...
export default function Rewards() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-primary/90 to-primary px-4 pt-8 pb-28">
      <div className="max-w-md mx-auto text-center text-primary-foreground">
        ...
        <h1 className="font-heading text-3xl font-bold mt-4 leading-tight">
      ...
      {/* WAYS TO EARN */}
      <div className="max-w-md mx-auto bg-card rounded-3xl shadow-xl p-5 mt-6">
      ...
      <div className="max-w-md mx-auto mt-6">
        {isFoundingMember ? (
          <div className="flex items-center gap-3 bg-amber-400 rounded-2xl p-4">
